                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button class="btn btn-success" @click = "newModal">
                                    Add New
                                    <i class="fas fa-user"></i></button> </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" v-else="editmode" id="addNewLabel">Update User's info</h5>
                    ...
                    <form @submit.prevent="editmode ? updateUser() : createUser()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select name="type" v-model="form.type" id="type" class="form-control" :class="{'is-invalid':
                            ...
                            <div class="form-group">
                                <input v-model="form.password" type="password" name="password"
                                       id="password" class="form-control" :class="{ 'is-invalid': form.errors.has('password') }">
...
export default {
    ...
    methods: {
        ...
        deleteUser(id){
            // delete function with sweetaleart
            Swal.fire({
                title: 'Are you sure?',
        ...
        loadUsers(){
            axios.get("api/users").then(({ data }) => (this.users = data.data));
                ...
                createUser(){
                    ...
                    .then(()=>{
                        Fire.$emit('AfterCreate');
                        $('#addNew').modal('hide') // hide the model after click
